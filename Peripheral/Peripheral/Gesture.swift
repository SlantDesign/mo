...
public struct Gesture {
    ...
    init(_ data: Data) {
        ...
        state = UIGestureRecognizerState(rawValue: UnsafePointer<Int>((data as NSData).bytes+index).pointee)!
        ...
        if type == GestureType.pan {
            ...
            direction = UnsafePointer<UISwipeGestureRecognizerDirection>((data as NSData).bytes + index).pointee
