...
class ScheduleLayout: UICollectionViewLayout {
    ...
    override func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        if elementKind == "HourHeaderView" {
            attributes.frame = CGRect(x: hour.width * CGFloat(indexPath.item + indexPath.section * maxIndex), y: UIScreen.main.bounds.maxY-37, width: CGFloat(hour.width), height: 37)
