...
class Planets: UniverseController, GCDAsyncSocketDelegate {
    ...
    func createPlanets() {
//        let compressedOrbits = [Rect(982.34, 594.72, 24.05, 10.24),
//                                Rect(972.15, 589.29, 46.02, 19.07),
//                                Rect(963.08, 585.8, 63.98, 26.36),
//                                Rect(942.21, 578.02, 97.07, 39.99),
//                                Rect(821.13, 531.13, 331.93, 136.75),
//                                Rect(680.33, 482.5, 613.15, 253.22),
//                                Rect(401.22, 350.99, 1230.75, 506.44),
//                                Rect(17.87, 206.51, 1925.55, 793.91),
//                                Rect(0, 0, 2403.36, 1023.55),
//                                Rect(993.55, 598.21, 2.76, 1.14)]
